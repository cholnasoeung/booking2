          ...
          <CardContent className="grid gap-5 py-6 lg:grid-cols-[1.7fr_0.8fr_0.8fr_auto]">
            ...
            <div className="flex flex-wrap items-center gap-3 lg:justify-end">
              <a
                ...
                download
                className="rounded-full border border-emerald-200 bg-emerald-50 px-4 py-2 text-sm font-medium text-emerald-700 transition hover:bg-emerald-100 flex items-center gap-2"
              >
