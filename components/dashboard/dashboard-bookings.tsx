...
import { formatBusType, formatCurrency, formatPaymentMethod, formatSeatList, formatTravelDate } from "@/lib/utils/formatters";
            ...
            <div className="pl-5 pr-5 pt-4 pb-4">
              ...
              <div className="flex flex-wrap items-start justify-between gap-3">
                    ...
                    <div className="flex flex-wrap items-center gap-1.5 mt-1">
                      ...
                      {isConfirmed && booking.paymentStatus === "pending" && (
                        <span className="inline-flex items-center gap-1 rounded-full bg-amber-100 px-2 py-0.5 text-xs font-bold text-amber-700">
                          <Clock className="h-3 w-3" /> Pay on boarding
                        </span>
                      )}
                      {past && isConfirmed && (
                ...
                <div className="text-right shrink-0">
                  <p className="text-[10px] uppercase tracking-widest text-slate-400 font-medium">
                    {booking.paymentStatus === "pending" ? "Amount due" : "Total paid"}
                  </p>
              ...
              <div className="mt-3.5 grid grid-cols-2 gap-2 sm:grid-cols-5">
                ...
                <div className="flex items-center gap-2 rounded-xl bg-slate-50 border border-slate-100 px-3 py-2.5">
                  ...
                  <div>
                    <p className="text-[9px] uppercase tracking-widest text-slate-400 font-semibold">Payment</p>
                    <p className="text-xs font-bold text-slate-700 mt-0.5">{formatPaymentMethod(booking.paymentMethod)}</p>
                  </div>
                </div>
              </div>
