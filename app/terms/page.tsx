        ...
        <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 space-y-8 text-sm leading-relaxed text-slate-600">
            <section>
              ...
              <p className="mt-2">
                By creating an account or booking a ticket through CambodiaBus, you agree to these
            ...
            <section>
              ...
              <p className="mt-2">
                ...
                company&apos;s onboard rules. CambodiaBus is not liable for missed departures due to
                late arrival.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                CambodiaBus facilitates bookings between passengers and bus operators. We are not
