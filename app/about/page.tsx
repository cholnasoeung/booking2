      ...
      <div className="min-h-screen bg-white">
        <section className="bg-gradient-to-r from-red-700 to-orange-500 py-16 text-white">
          <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            ...
            <h1 className="text-3xl font-bold sm:text-4xl">About CambodiaBus</h1>
        ...
        <section className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 leading-relaxed text-slate-600">
            ...
            counters, and uncertainty about seat availability. CambodiaBus was built to replace that
